        ...
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            ...
            <div className='flex flex-wrap mt-10 justify-center gap-5'>
                {AiToolsData.map((tool, index) => (
                    <div key={index} className='p-8 mp-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:translate-y-1 transition-all duration-300 cursor-pointer' onClick={() => user && navigate(tool.path)}>
                        <tool.Icon className='h-12 w-12 p-3 text-white rounded-xl' style={{
